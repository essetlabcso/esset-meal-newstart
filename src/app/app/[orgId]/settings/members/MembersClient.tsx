...
export default function MembersClient({
    ...
    function onDeactivate(userId: string) {
        const formData = new FormData();
        formData.set("orgId", orgId);
        ...
        <div className="space-y-5">
            ...
            <section className="esset-card p-6">
                <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <h1 className="text-2xl font-black text-esset-ink">Workspace members</h1>
                                    ...
                                    <td className="rounded-r-xl px-2 py-3">
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <button
                                                ...
                                                className="rounded-lg border border-esset-border bg-white px-2 py-1 text-xs font-semibold text-esset-muted hover:bg-esset-bg"
                                            >
                                                Deactivate
                                            </button>
                                            <button
            ...
            <section className="esset-card p-6">
                <h2 className="text-xl font-extrabold text-esset-ink">Pending invites</h2>
                {(invites.length ?? 0) === 0 ? (
